...
public class EngineProbe {
 public static void main(String[] args)throws Exception {
  ...
  for(int i=0;i<list.getLength();i++) {var e=(Element)list.item(i);var m=new Mode(e.getAttribute("NAME").toLowerCase(java.util.Locale.ROOT));m.setProperty("file",base.resolve("modes").resolve(e.getAttribute("FILE")).toString());if(e.hasAttribute("FILE_NAME_GLOB"))m.setProperty("filenameGlob",e.getAttribute("FILE_NAME_GLOB"));m.init();ModeProvider.instance.addMode(m);}
